import os
from Insurance.entity.config_entity import TRANSFORM_OBJECT_FILE_NAME, TARGET_ENCODER_OBJECT_FILE_NAME, MODEL_FILE_NAME
from glob import glob
from typing import Optional
import os

# Folder (new model saved)
# Comparison of new model vs old model
...
class ModelResolver():
    ...
    def get_latest_target_encoder_path(self):
        try:
            latest_dir = self.get_latest_dir_path
            if latest_dir==None :
                raise Exception(f"Target encoder path is not available")
    ...
    def get_latest_save_dir_path(self)-> str:
        try:
            ...
            latest_dir_num = int(os.path.basename(self.get_latest_dir_path())) #not understood
