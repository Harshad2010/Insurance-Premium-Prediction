from Insurance.entity import artifacts_entity, config_entity
...
class DataValidation:
    ...
    def drop_missing_values_columns(self, df :pd.DataFrame, report_key_name :str)->Optional[pd.DataFrame]:
        ...
        try:
            ...
            null_report = df.isna().sum()/len(df)
    ...
    def is_required_columns_exists(self,base_df:pd.DataFrame,current_df :pd.DataFrame, report_key_name: str)->bool:
        try:
            base_columns = base_df.columns # columns present insurance.csv
            current_columns = current_df.columns  # columns present in train/test.csv
    ...
    def data_drift(self, base_df : pd.DataFrame, current_df : pd.DataFrame, report_key_name: str):
        try:
            ...
            for base_column in base_columns:
                ...
                logging.info(f"Starting Hypothesis Test")
                if same_distribution.pvalue>0.05:
                    ...
                    logging.info(f"We failed to null hypothesis")
                    drift_report[base_column]={
                        "pvalues":float(same_distribution.pvalue),
    ...
    def initiate_data_validation(self)-> artifacts_entity.DataValidationArtifact:
        try:
            ...
            # checking is_required_columns_exists function
            ...
            # checking train and test status for data drift function
